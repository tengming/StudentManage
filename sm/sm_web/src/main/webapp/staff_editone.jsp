...
<div id="right_ctn">
    <div class="right_m">
        <div class="hy_list">
            ...
            <form action="editone.do" method="post" name="addForm">
                ...
                <div class="xjhy">
                    ...
                    <ul class="hypz gjpz clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="name" type="text" value="${USER.name}">
                                <i>*</i>
                            </div>
                        </li>
                        <li class="clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <select name="did">
                                    ...
                                    <c:forEach items="${DEPARTONE}" var="dep">
                                        <c:if test="${STAFFONE.did==dep.id}">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="idNumber" type="text" value="${STAFFONE.idNumber}">
                                <i>*</i>
                            </div>
                        </li>
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="bornData" type="text" value="<fmt:formatDate
                                                        value="${STAFFONE.bornData}" pattern="yyyy-MM-dd"/>">
                                <i>*</i>
                            </div>
                        </li>
